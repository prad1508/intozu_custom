# Copyright (c) 2023, Stackerbee and contributors
...
def get_columns():
	columns = [
		...
		{
			"label": _("Original Qty On Pick"),
			"fieldname": "qty_on_pick",
			"fieldtype": "Float",
			"width": 100,
			"convertible": "qty",
		},
		{
			"label": _("Reserved Qty For Picking"),
		...
		{
			"label": _("Reverse Pick Qty"),
			"fieldname": "reverse_pick",
			"fieldtype": "Float",
			"width": 150,
			"convertible": "qty",
		},
		...
		{"label": _("Type Of Transaction"), "fieldname": "type_of_transaction", "width": 150},
